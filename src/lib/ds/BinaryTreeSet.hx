...
class BinaryTreeSet<T> extends Set<T> implements ITree<T>
{
     ...
     *
     * @var lib.ds.BinaryTreeSet.Node<T>
     */
     ...
     *
     * @return lib.ds.BinaryTreeSet.SearchResult<T
     */
     ...
     *
     * @param lib.ds.BinaryTreeSet.Node<T> root     the root from which to start the traverse
     * @param Int                            level    the current level we are in
     * @param lib.Callback<T>              callback the callback to execute for each item
     */
