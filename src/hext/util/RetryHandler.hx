...
import hext.util.RetryHandlerAbortedException;
import hext.util.RetryLimitReachedException;
...
class RetryHandler<T>
{
     ...
     * @return T
     *
     * @throws hext.util.IllegalArgumentException     if 'retries' if less than 1
     * @throws hext.util.RetryLimitReachedException   if the function doesn't return successfully after 'retries' retries
     * @throws hext.util.RetryHandlerAbortedException if the abort call has ended the retry loop
     */
