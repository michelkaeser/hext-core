...
interface IList<T> extends ICollection<T>
{
     ...
     * a hext.ds.IndexOutOfBoundsException should be thrown.
     *
     ...
     * a hext.ds.IndexOutOfBoundsException or hext.ds.NoSuchElementException should be thrown.
     *
     * @return T
     */
