 ...
 * If you need an IList with fast random access, you'd better use an hext.ds.ArrayList.
 *
 * Use cases:
...
class LinkedList<T> extends List<T>
{
     ...
     *
     * @var hext.ds.LinkedList.Element<T>
     */
    @:allow(hext.ds.LinkedList.Iterator)
...
class Iterator<T> extends ListIterator<T>
{
     ...
     *
     * @param hext.ds.LinkedList<T> list the LinkedList to iterate over
     */
    @:access(hext.ds.LinkedList.anchor)
